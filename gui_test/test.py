...
#		self.resize(900,400)
    ...
    def open_dialog(self):
        ...
        runPath = QUrl("sftp://129.89.57.10")
        print(runPath)
        fileName, _ = QFileDialog.getOpenFileUrl(self.tab1,"Open Dialogue", runPath, "All Files (*);;Python Files (*.py);;Image Files (*jpeg, *.png)", options=options)
        if fileName:
